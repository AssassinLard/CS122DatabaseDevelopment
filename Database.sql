...
VALUES (NULL, 0101, "JACO","ABAT", 2009.00,'2018-04-28','2018-04-29',"FACULTY","SINGLE", 45000.00 );

INSERT INTO employee 
VALUES (NULL, 1212, 'BRIAN','PACIA', '2108','2017-03-27','2019-05-30','FACULTY','MARRIED', 50001 );

INSERT INTO employee 
VALUES (NULL, 1234, 'OWEN','MEDINA', '4607','2016-02-26',null,'FACULTY', 'MARRIED', 52023 );

INSERT INTO employee 
VALUES (NULL, 5678,'ANDREA','ANG', '4806','2015-01-25','2021-07-02','FACULTY','SINGLE', 48204);

INSERT INTO employee 
VALUES (NULL, 9012, 'PIEL','ARCILLA', '2405','2014-12-20','2022-08-03','FACULTY','SINGLE', 37708 );

INSERT INTO employee 
VALUES (NULL, 3456, 'STEPHANIE','ROBLES', '2504','2013-11-19','2023-09-04','FACULTY','MARRIED', 38963);

INSERT INTO employee 
VALUES (NULL, 0934, 'GOMER','ABESAMIS', '2603','2012-10-18','2024-10-05','ADMIN','WIDOWER', 53198 );

INSERT INTO employee 
VALUES (NULL, 5937, 'KRISTI','INGCO', '2802','2011-09-17','2025-11-06','ADMIN','WIDOW', 54000);

INSERT INTO employee 
VALUES (NULL, 0321, 'KENNETH','ALOG', '2301','2010-08-16','2023-12-20','FACULTY','MARRIED', 41101 );
